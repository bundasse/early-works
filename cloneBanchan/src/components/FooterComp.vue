    ...
    <div>
        <div class="border-t py-10">
            ...
            <div class="basis-[33%]">
                ...
                <p class="mt-3 text"><img :src="require(`@/assets/icon/message.svg`)" class="inline" alt="">zipbanchan@sannamchon.co.kr</p>
            </div>
            <div class="basis-[40%]">
                <h5 class="text-xs text-gray-600 font-bold mb-5">고객센터</h5>
                <p class="text-2xl font-bold mb-5"><img :src="require(`@/assets/icon/call.svg`)" class="inline" alt=""> 1588-3754</p>
                <p class="flex flex-col text-[13px] text-gray-600">
        ...
        <div class="w-full bg-[#f7f7f7]">
            <div class="max-w-6xl mx-auto text-xs py-[30px] relative">
                ...
                <div>
                    집반찬연구소 <button class="text-gray-400 underline ml-2" @click="addressOpen = !addressOpen">자세히보기</button>
                ...
                <div class="w-52 absolute right-0 top-[30px] flex gap-3">
                    <img :src="require(`@/assets/icon/inipay_60x60_gray.png`)" class="inline" alt="">
                    <img :src="require(`@/assets/icon/escrow_60x60_gray.png`)" class="inline" alt="">
                </div>
            </div>
        </div>
    </div>
